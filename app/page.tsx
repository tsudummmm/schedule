...
## ステップ2：スケジュール出力
ユーザーの回答後、以下のフォーマットを厳守してスケジュールを作成してください。
